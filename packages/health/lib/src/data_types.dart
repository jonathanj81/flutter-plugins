...
const List<HealthDataType> _dataTypeKeysIOS = [
  ...
  HealthDataType.STANDING_TIME,
  HealthDataType.MOVING_TIME,
...
const Map<HealthDataType, HealthDataUnit> _dataTypeToUnit = {
  ...
  HealthDataType.RESPIRATORY_RATE: HealthDataUnit.BREATHS_PER_MINUTE,
  ...
  HealthDataType.MOVING_TIME: HealthDataUnit.MINUTE,
  HealthDataType.STANDING_TIME: HealthDataUnit.MINUTE,
